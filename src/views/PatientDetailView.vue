...
import { persistProviderLinks } from '@/services/api/patients'
import { usePatientsStore } from '@/stores/patients'
import { useProvidersStore } from '@/stores/providers'

const LinkProviderModal = defineAsyncComponent(
  () => import('@/components/patients/LinkProviderModal.vue'),
)
      ...
      <article class="panel">
        ...
        <dl class="details-grid">
          ...
          <div>
            ...
            <dd>
              <span class="badge">{{ patient.providerIds.length }} linked providers</span>
            </dd>
          </div>
          <div class="details-grid__wide">
            <dt>Address</dt>
            <dd>
              {{ patient.address.street }}, {{ patient.address.suburb }}, {{ patient.address.city }},
              {{ patient.address.province }}, {{ patient.address.postalCode }}
            </dd>
          </div>
        </dl>
      </article>
